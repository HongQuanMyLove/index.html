...
$(function(){
  ...
  __GetIP();
  __GetInfo();
  console.log("%c🌳 Name：HongQuanDepTrai | Bio：Sayy Hello | Url：https://www.thanhdieu.com 🌳", "font-family: ;color:#fff; background: linear-gradient(270deg, #18d7d3, #68b7dd, #8695e6, #986fee); padding: 8px 15px; border-radius: 8px");
  console.log("…………./´¯/)……….. (\\¯’\\\n…………/….//……….. …\\\\….\\\n………../….//………… ….\\\\….\\\n…../´¯/…./´¯\\\\………../¯‘\\\\…./¯’\\\\\n.././…/…./…./.|_|……_| .\\\\…\\\\…\\\\…\\\\.\\\\\n(.(….(….(…./.)..)..(..(. \\\\….)….)….).)\n.\\\\…………….\\/…/…\\\\. ..\\/……………./\n..\\\\…………….. /……..\\\\………………../\n…\\\\…………..(………. ..)……………./");
});
// CHECK FPS
...
strings: ["","Hey Honey, I'm a Designer.", "I like website design and like you :3 "],
typeSpeed: 95,
backSpeed: 75,
loop: true
})
...
$(document).ready(function() {
  ...
  $('#Facebook').click(function() {
      OpenUrl('https://www.facebook.com/profile.php?id=100004025965383');
  });
    // SET URL YOUTUBE
  $('#Youtube').click(function() {
      OpenUrl('https://www.youtube.com/@_.hwuann');
  });
  // SET URL DISCORDS
  $('#Discord').click(function() {
      OpenUrl('https://discord.com/users/1165478923950370867');
  });
    // SET URL INSTAGRAM
  $('#Instagram').click(function() {
      OpenUrl('https://instagram.com/24th.ofdecber/');
  });
});
...
Swal.fire({
  title: '𝙉𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣 !',
  text: '=>> 𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑯𝒐𝒏𝒆𝒚 𝑩𝒂𝒄𝒌 𝑻𝒐 𝑻𝒉𝒆 𝑯𝒐𝒎𝒆𝑷𝒂𝒈𝒆 🐬 <<=',
